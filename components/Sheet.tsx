...
export function Sheet({
  ...
  return (
    <dialog
      ...
      className="fixed inset-x-0 bottom-0 top-auto m-0 mx-auto flex max-h-[85dvh] w-full max-w-[32rem] flex-col overflow-hidden bg-surface p-0 text-foreground surface-sheet"
    >
