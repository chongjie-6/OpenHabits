/**
 * Records the README's demo GIF into docs/media/: a morning's ticks, the year
 * grid, and the share card the app draws from it. Same setup as shoot.mjs, plus
 * two encoders it does not need:
 *
